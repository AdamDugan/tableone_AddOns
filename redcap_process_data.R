...
## Objective:
## We'd like to be able to directly take the objects REDCap gives you when you select Download for R and process them in a sensible way
## without having to manually edit them. This includes removing the duplicate ".factor" variables from the dataset while retaining
## the REDCap-supplied variable labels.

## Arguments:
## folder_name_with_redcap_files = the name of the folder containing both the REDCap data file and the REDCap R script 
